 ...
 * `prisma.store`: Exposes CRUD operations for the **Store** model.
  ...
  */
    ...
    /**
     * `prisma.whatsAppUser`: Exposes CRUD operations for the **WhatsAppUser** model.
      * Example usage:
      * ```ts
      * // Fetch zero or more WhatsAppUsers
      * const whatsAppUsers = await prisma.whatsAppUser.findMany()
      * ```
      */
    get whatsAppUser(): Prisma.WhatsAppUserDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
